...
using Necnat.Abp.NnLibCommon.Phonetics;
using System.Collections.Generic;
using System.Text.RegularExpressions;

namespace Necnat.Abp.NnLibCommon.Br.Phonetics
{
    public class BuscaBR2011 : IPhoneticSearch
    {
        public string? Phonetize(string? s)
        {
            if (s == null)
                return null;
